    ...
    async (reset = false) => {
      ...
      try {
        ...
        if (result && result.snippets) {
          ...
          setHasMore(
            result.snippets.length === 4 && result.lastVisible !== null,
          );
        } else {
          setSnippets([]);
          setHasMore(false);
  ...
  return (
    <div>
      <div className="lg:flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-white mb-5 lg:mb-0">
        ...
        <div className="flex flex-col w-full">
          <div>
            <p className="mt-2 text-gray-400 block">
              Create your first code snippet by clicking the "Create a snippet"
              button above.
            </p>
          </div>
        </div>
